...
- `*_metadata.json`: a sidecar with emitted function names, block labels, named data/address constants, source symbol names, and provenance (`imported` vs `autogenerated`)
