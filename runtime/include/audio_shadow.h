...
// re-render of a guest audio engine (here the Game Boy 4-channel PSG/APU,
// rendered in float free of the hardware's integer requantization and the
// final DC-blocker) runs ALONGSIDE the canon APU mix, never replacing it. This
// verifier decides, from the running canon stream, whether the shadow is
// proven enough to substitute, and reverts loudly the instant it stops
// matching:
//
...
//
// The canon (emulated APU) output stays the verify oracle; the shadow is never
...
// permission. Engine-agnostic; reused verbatim across the recomp ecosystem.

#ifndef GBCRECOMP_AUDIO_SHADOW_H
#define GBCRECOMP_AUDIO_SHADOW_H
...
#endif  // GBCRECOMP_AUDIO_SHADOW_H
